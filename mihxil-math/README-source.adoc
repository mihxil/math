...
Some videos are available to show this, which are not working here. Visit this page on link:https://mihxil.github.io/math/#_cartesian_product_of_streams[github pages]

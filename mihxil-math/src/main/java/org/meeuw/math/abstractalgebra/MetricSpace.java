...
/**
 * A <a href="https://en.wikipedia.org/wiki/Metric_space">metric space</a> is a set of elements, where each two elements have a {@link MetricSpaceElement#distanceTo(MetricSpaceElement) distance} between each other.
 * <p>
 ...
 * @since 0.4
 * @param <E> the type of the points in this space
 * @param <S> the type of the distance between 2 points in this space
 */

...
image:https://img.shields.io/nexus/s/https/oss.sonatype.org/org.meeuw/mihxil-math.svg[snapshots,link=https://oss.sonatype.org/content/repositories/snapshots/org/meeuw/]
image:http://www.javadoc.io/badge/org.meeuw/mihxil-math.svg?color=blue[javadoc,link=http://www.javadoc.io/doc/org.meeuw/mihil-math]

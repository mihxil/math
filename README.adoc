...
- An Service Provider Interface for formatting the elements of abstract algebras.  The core module only provides an implementation to format  uncertain numbers, using proper rounding and scientific notation.

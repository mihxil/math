...
[source,java]
----
Unresolved directive in mihxil-configuration/README-source.adoc - include::mihxil-math/src/test/java/org/meeuw/test/examples/ConfigurationExample.java[tag=configurationService,indent=-]
----

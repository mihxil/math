...
The 'physics' module will add to this that these kind of uncertainties may originate not only in the finite nature of representing them, but also in the limitations of actually _measuring_ things.

...
The link:https://mihxil.github.io/math/#_dynamic_date_time_parsing[`mihxil-time`] module contains a 'dynamic date parser. I dusted this off from old link:https://www.mmbase.org[mmbase] code.

...
The link:https://github.com/mihxil/math/tree/main/mihxil-time[`mihxil-time`] module contain a 'dynamic date parser. I dusted this of from old link:https://mmbase.org[mmbase] code.

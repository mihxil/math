...
ifndef::htmled[]
See link:https://mihxil.github.io/math/[this file in html] for proper display of the (few) mathematical equations and MP4-movies. Also, this will include a link:https://mihxil.github.io/math/[working demo] (using webassembly).
endif::[]

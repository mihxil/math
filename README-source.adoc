...
algebraic structures, physics, statistics, time, shapes and theories
...
[NOTE]
====
See link:https://mihxil.github.io/math/[this file in HTML] for proper display of the (few) mathematical equations and MP4-movies. This has some working demo's, but those are better elaborated in this link:https://mihxil.github.io/math/DEMO.html[dedicated page for that]. This uses webassembly to run java in your browser.
====
endif::[]

include::docs/QUICKSTART-source.adoc[leveloffset=1]

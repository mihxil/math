...
[source,java]
----
include::src/test/java/org/meeuw/test/physics/PhysicalNumberTest.java[tag=imports, indent=0]
...
include::src/test/java/org/meeuw/test/physics/PhysicalNumberTest.java[tag=add, indent=0]
----

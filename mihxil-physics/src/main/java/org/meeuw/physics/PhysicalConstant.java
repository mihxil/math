...
public class PhysicalConstant extends PhysicalNumber {
    ...
    public static final PhysicalConstant G  = new PhysicalConstant("G",
        new UncertainDoubleElement(6.6743e-11d, 0.00015e-11d), UnitsImpl.of(SIUnit.m, SIUnit.m, SIUnit.m).dividedBy(UnitsImpl.of(SIUnit.kg, SIUnit.s, SIUnit.s)), "Gravitational Constant");

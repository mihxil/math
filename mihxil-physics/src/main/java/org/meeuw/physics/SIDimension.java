 ...
 * @since 0.3
 */
public enum SIDimension implements Dimension, DimensionExponent<SIDimension> {
     ...
     * @see SIDimension#Θ
     */
    public static final SIDimension TH = Θ;
    ...
    SIDimension(char i, String name) {
        toString = String.valueOf(i);
        this.name = name;
    }

    SIDimension(String name) {
        this.name = name;
        toString = name();
    }
    ...
    @Override
    public SIDimension getDimension() {
        return this;
    }

 ...
 * @since 0.15
 */
public interface StatisticalDuration<SELF extends StatisticalDuration<SELF, N, E>, N extends Number, E>
    extends
    UncertainDuration<N>, StatisticalNumber<SELF, N, E>, LongConsumer, IntConsumer, Temporal {

    @Override
    default Duration durationValue() {
        return optionalDurationValue()
            .orElseThrow(() -> new NoValues("no values entered", this + ".duration"));
    }

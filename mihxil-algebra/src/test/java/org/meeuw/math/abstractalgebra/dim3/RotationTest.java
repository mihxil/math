...
class RotationTest {
    ...
    public void roty() {
        ...
        FieldVector3<DoubleElement> v = of(1, 0, 0);
        FieldVector3<DoubleElement> rotated = y.rotate(v);
    ...
    public void rotz() {
        ...
        FieldVector3<DoubleElement> v = of(0, 1, 0);
        FieldVector3<DoubleElement> rotated = z.rotate(v);
